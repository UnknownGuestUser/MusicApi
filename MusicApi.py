...
YTDLP_COMMON = [
    ...
    "--force-ipv4",
    "--js-runtimes",       "deno:/root/.deno/bin/deno,node:/usr/bin/node",
...
async def run_cmd(cmd) -> bool:
    env = os.environ.copy()
    env["PATH"] = "/root/.deno/bin:/home/ubuntu/myenv/bin:" + env.get("PATH", "")
    env["HOME"] = "/root"
...
async def yt_search_first(query) -> Optional[str]:
    ...
    ok, out = await run_cmd_out([
        "/home/ubuntu/myenv/bin/yt-dlp", *YTDLP_COMMON,
